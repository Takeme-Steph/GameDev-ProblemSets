...
function Level:init()
    ...
    function beginContact(a, b, coll)
        ...
        if types['Obstacle'] and types['Player'] then
            ...
            -- update player body to show it has hit something
           self.launchMarker.Phit = true
...
function Level:update(dt)
    ...
    if self.launchMarker.launched then
        local stopCount = 0
        for i = 1, #self.launchMarker.alien do
        ...
        if stopCount == #self.launchMarker.alien then
            for i = 1, #self.launchMarker.alien do
                self.launchMarker.alien[i].body:destroy()
            end
            self.launchMarker = AlienLaunchMarker(self.world)
            self.launchMarker.Phit = false
