...
-- switch to know if the player is using a mouse or keyboard
MOUSE = false
...
-- get and store mouse details when it's clicked
function love.mousepressed(x, y, button, istouch, presses)
    love.mouse.buttonsPressed[button] = {status = true, x = x, y = y}
end
...
-- store and update mouse location when its moved
function love.mousemoved(x, y, dx, dy, istouch)
    -- get the coordinates of the mouse and convert it to its location on the game
