            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        -- store old stats
                        local oldStats = {hp = self.playerPokemon.HP,
                        ...
                        -- store new stats
                        local NewStats = {hp = self.playerPokemon.HP,
                                          attack = self.playerPokemon.attack,
                                          defense = self.playerPokemon.defense,
                                          speed = self.playerPokemon.speed
                        }
                        -- store change in stats
                        local StatChange = {hp = HPIncrease,
                        ...
                        Timer.after(1, function()
                            gStateStack:push(LevelUpState(oldStats, NewStats, StatChange))
                        end)
                    else
                        self:fadeOutWhite()
                    end
